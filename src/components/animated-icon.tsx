...
export function AnimatedSplashOverlay() {
  ...
  const image = <Image style={styles.animatedIconImage} source={require('@/assets/images/expo-logo.png')} />;
...
export function AnimatedIcon() {
  return (
    <View style={styles.animatedIconContainer}>
      ...
      <Animated.View entering={keyframe.duration(DURATION)} style={styles.animatedIconBackground} />
      <Animated.View style={styles.animatedIconImageContainer} entering={logoKeyframe.duration(DURATION)}>
        <Image style={styles.animatedIconImage} source={require('@/assets/images/expo-logo.png')} />
      </Animated.View>
    </View>
  );
}
